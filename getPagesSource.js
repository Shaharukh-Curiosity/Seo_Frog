...
function Page_Headers() {
  var page_headers = "";
  page_headers += "\n Page headers\n\n";
  page_headers += " H1 : " + Total_H1() + "\n";
  page_headers += " H2 : " + Total_H2() + "\n";
  page_headers += " H3 : " + Total_H3() + "\n";
  page_headers += " H4 : " + Total_H4() + "\n";
  page_headers += " H5 : " + Total_H5() + "\n";
  page_headers += " H6 : " + Total_H6() + "\n";
...
function Find_Broken_Links() {
  ...
  for (var i = 0; i < total_broken_links.length; i++) {
   ...
   if (broken_links) {
    return  total_broken_link_found += "Borken Links : " + broken_links;
  } else {
      return total_broken_link_found += "Broken Links : " + "No Broken Links Found";
  }
...
function Page_Links() {
  ...
  broken_links += "//Below Link are pointing in Link  href\n ";
...
function Total_Images_Without_Alt() {
  ...
  for (var i = 0; i < total_image_alt.length; i++) {
    if (
      ...
      images_without_alt_path+= total_image_alt[i].src + '\n\n';
...
function Total_Images_Without_Title() {
  ...
  for (var i = 0; i < total_image_title.length; i++) {
    if (
      ...
      images_without_title_path+= total_image_title[i].src + '\n\n';
...
function Get_Images() {
  ...
  page_image_info +=
   ...
   page_image_info += "-----------------\n";
   page_image_info += 'Without Alt' + '\n'
   page_image_info+='-----------------\n\n'

   page_image_info += images_without_alt_path;

   page_image_info += "-----------------\n";
   page_image_info += 'Without Title' + '\n'
   page_image_info+='-----------------\n\n'

   page_image_info += images_without_title_path;
